!function (t, e) {
    ...
    var N = "SweetAlert2:", D = function (t) {
        ...
        W = t(["success", "warning", "info", "question", "error"]), K = function () {
    ...
    function nt(t, e) {
        var n = 1 < arguments.length && void 0 !== e && e, o = H();
    ...
    var ct, st = function (t, e) {
        ...
        ft = function (t) {
            if (!function () {
            ...
            }(), ot()) h("SweetAlert2 requires document to initialize"); else {
                ...
                n.appendChild(e), function (t) {
                    ...
                    var t = A(), e = lt(t, z.input), n = lt(t, z.file),
                        o = t.querySelector(".".concat(z.range, " input")),
                        i = t.querySelector(".".concat(z.range, " output")), r = lt(t, z.select),
                        a = t.querySelector(".".concat(z.checkbox, " input")), c = lt(t, z.textarea);
    ...
    function Bt(t, e) {
        ...
        e.html ? (rt(e.html, n), X(n, "block")) : e.text ? (n.textContent = e.text, X(n, "block")) : G(n), function (t, o) {
            var i = A(), e = yt.innerParams.get(t), r = !e || o.input !== e.input;
    ...
    function Tt(t, e) {
        var n = O();
        R(n, e, "header"), St(0, e), function (t, e) {
            var n = yt.innerParams.get(t);
            if (n && e.icon === n.icon && k()) R(k(), e, "icon"); else if (Mt(), e.icon) if (-1 !== Object.keys(W).indexOf(e.icon)) {
    ...
    function Lt(t, e) {
        ...
        }(0, e), vt(0, e), Tt(t, e), Bt(t, e), at(0, e), function (t, e) {
            var n = M();
    ...
    function ne(t, e, n, o) {
        n ? ae(t, o) : (Nt().then(function () {
            return ae(t, o)
        }), zt.keydownTarget.removeEventListener("keydown", zt.keydownHandler, {capture: zt.keydownListenerCapture}), zt.keydownHandlerAdded = !1), e.parentNode && e.parentNode.removeChild(e), I() && (null !== Y.previousBodyPadding && (document.body.style.paddingRight = "".concat(Y.previousBodyPadding, "px"), Y.previousBodyPadding = null), function () {
        ...
        if (e) {
            ...
            if (n && !q(e, n.hideClass.popup)) {
                ...
                ut(i, n.showClass.backdrop), st(i, n.hideClass.backdrop), function (t, e, n) {
                    var o = y(), i = ht && et(e), r = n.onClose, a = n.onAfterClose;
    ...
    function be(e, t, n, o) {
        t.keydownTarget && t.keydownHandlerAdded && (t.keydownTarget.removeEventListener("keydown", t.keydownHandler, {capture: t.keydownListenerCapture}), t.keydownHandlerAdded = !1), n.toast || (t.keydownHandler = function (t) {
            return Ve(e, t, n, o)
        }, t.keydownTarget = n.keydownListenerCapture ? window : C(), t.keydownListenerCapture = n.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, {capture: t.keydownListenerCapture}), t.keydownHandlerAdded = !0)
    }
    ...
    var Ze, Qe = Object.freeze({
        hideLoading: $t, disableLoading: $t, getInput: function (t) {
            ...
            var t = C(), n = yt.innerParams.get(this);
