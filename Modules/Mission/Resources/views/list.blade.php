                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                        ...
                        @foreach($Missions as $Mission)
                            <tr>
                                ...
                                <td>
                                    @if(empty($Mission->Supervisor))
                                        <a href="{{route('admin.module.mission.edit',$Mission->id)}}">
                                            <img src="{{url('/icon/icons8-edit-property-48.png')}}"
                                                 width="25" title="ویرایش ">
                                        </a>
                                        <a href="{{route('admin.module.mission.delete',$Mission->id)}}">
                                            <img src="{{url('/icon/icons8-delete-bin-48.png')}}"
                                                 width="25" title="حذف ">
                                        </a>
                                    @else
                                        <a href="{{route('admin.module.mission.save',$Mission->id)}}"><span
                                                class="btn btn-danger">بایگانی</span></a>
                                    @endif
